<template>
    <div class="promotion-bao">
        <h1 class="text-center fw-bold border-bottom pb-4 bg-white title pt-4">Promotion</h1>
                        ...
                        <!-- <div class="carousel-item p-2">
                            <div class="promotion-card">
                                ...
                                <div class="promotion-details">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="promotion-title">Summer Special - Hot deals for you</h5>
                                            <div class="promotion-expiry">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-calendar3" viewBox="0 0 16 16">
                                                    <path
                                                ...
                                                <span>Ends on 30/6/2025</span>
                                            </div>
                                        </div>
                                        <button class="btn btn-primary collect-btn">Collect</button>
                                    </div>
                                </div>
                            </div>
                        </div> -->
                        ...
                        <!-- <div class="carousel-item p-2">
                            <div class="promotion-card">
                                ...
                                <div class="promotion-details">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="promotion-title">Spring Offer - Refresh your style</h5>
                                            <div class="promotion-expiry">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-calendar3" viewBox="0 0 16 16">
                                                    <path
