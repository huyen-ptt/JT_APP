            ...
            <div class="mb-container">
               ...
               <div class="promo-carousel">
                  ...
                  <div class="promo-card">
                     <img src="../assets/images/IMG.png" alt="Winter Deal - 20% OFF" />
                  </div>

                  <!-- Promotion Card 2 -->
                  <div class="promo-card">
                     <img src="../assets/images/IMG.png" alt="Summer Special" />
                  </div>

                  <!-- Promotion Card 3 -->
                  <div class="promo-card">
                     <img src="../assets/images/IMG.png" alt="Holiday Package" />
                  </div>

                  <!-- Promotion Card 4 -->
                  <div class="promo-card">
                     <img src="../assets/images/IMG.png" alt="Weekend Getaway" />
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container-destination">
            ...
            <div class="grid-destination">
               ...
               <RouterLink to="/destination">
                  <div class="card-destination des1">
                     <img src="../assets/images/8.png" alt="Hà Nội" class="image-destination">
                  ...
                  <!-- Hạ Long -->
                  <div class="card-destination des2">
                     <img src="../assets/images/2.png" alt="Hạ Long" class="image-destination">
                     <div class="location-destination">
                        <i class="fas fa-map-marker-alt icon-destination"></i>
                        <span>Ha Long</span>
                     </div>
               ...
               <!-- TP. Hồ Chí Minh -->
               <div>
                  <div class="card-destination des3">
                     <img src="../assets/images/7.png" alt="TP. Hồ Chí Minh" class="image-destination">
                     <div class="location-destination">
                        <i class="fas fa-map-marker-alt icon-destination"></i>
                  ...
                  <!-- Huế -->
                  <div class="card-destination des4">
                     <img src="../assets/images/6.png" alt="Huế" class="image-destination">
                     <div class="location-destination">
                        <i class="fas fa-map-marker-alt icon-destination"></i>
                        <span>Hue</span>
                     </div>
