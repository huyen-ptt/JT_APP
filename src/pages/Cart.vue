            ...
            <div class="body-cart">
                <div class="select-all-container d-flex align-items-center">
                    <input type="checkbox" class="custom-checkbox form-check-input" id="selectAll"
                        v-model="isSelectAllCart" @change="onChangeCheckAllCart()">
                ...
                <div class="p-3">
                    <div class="d-flex justify-content-center align-items-center" v-for="(cart, index) in carts"
                        ...
                        <div class="news-card-blogg border">
                            ...
                            <div class="pe-3">
                                <img :src="helper.getImageCMS(cart.avatar)" alt="Da Nang ancient town"
                                    class="img-cart" />
                            </div>
                                    ...
                                    <div class="">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="guest-select mb-2"
                                                @click="cart.isOpenModalChangeQuantity = true">
                                                ...
                                                <Drawer v-model:visible="cart.isOpenModalChangeQuantity"
                                                    :header="$t('select_quantity')" position="bottom"
                                                    ...
                                                    <div class="quantity-selector-so-luong">
                                                        ...
                                                        <div class="price-item-so-luong d-flex justify-content-between align-items-center"
                                                            ...
                                                            <div>
                                                                <div class="price-label-so-luong">{{ cart.dvTreEm }}
                                                                </div>
                                                                <div class="price-amount-so-luong">VND {{
